	...
	<div class="container">
	  <!-- Content here -->
	   ...
	   <div class="row justify-content-md-center" style="margin-top: 10px;">
	   	...
	   	<div class="col-4">
	   		<button type="button " onclick="window.loation.href='bayar.php'" class="btn btn-light btn-lg btn-block shadow-sm p-3 mb-5 bg-white rounded btn-img " style="margin-left: 1px;"><img src="assets/img/menu-1.png" height="50px" width="70px" alt="kasir"><br>Bayar</button>
	   	</div>
	   	<div class="col-4">
	   		<button type="button" class="btn btn-light btn-lg btn-block shadow-sm p-3 mb-5 bg-white rounded"><img src="assets/img/menu-2.png" height="50px" width="60px" alt="pendapatan"><br><span class="menu-text">Income</span></button>
	   	</div>
	   	<div class="col-4">
	   		<button type="button" class="btn btn-light btn-lg btn-block shadow-sm p-3 mb-5 bg-white rounded"><img src="assets/img/menu-3.png" height="50px" width="60px" alt="pengeluaran"><br><span class="menu-text">Outcome</span></button>
	   	</div>
	   </div>
